...
public class InternalRateLimitStatus implements RateLimitStatus {
    ...
    /**
     * Dummy RateLimitStatus: for endpoints with "no ratelimit" from Twitter
     * API, and aggregates.
     */
    ...
    public final String toString() {
        return "RateLimitStatusJSONImpl{" + "remaining=" + remaining
                + ", limit=" + limit + ", resetTimeInSeconds="
                + resetTimeInSeconds + ", secondsUntilReset="
                + secondsUntilReset + '}';
    }
