...
/*
 * Container for different Endpoint Names, and priority queues.
 * Uses Enum Singleton pattern because we only want 1 global instance of each endpoint+bot. 
...
public enum EndPoint implements GetBotQueue, ApplicationOnlySupport {
	...
	STATUSES_RETWEETERS { 
		@Override public String toString() { return "/statuses/retweeters/ids"; } 
	},
	STATUSES_SHOW { 
		@Override public String toString() { return "/statuses/show/:id"; } 
	},
	STATUSES_LOOKUP { 
		@Override public String toString() { return "/statuses/lookup"; } 
	},
	...
	FOLLOWERS_LIST { 
		@Override public String toString() { return "/followers/list"; } 
	},
	FOLLOWERS_IDS {	
		@Override public String toString() { return "/followers/ids";	 } 
	},

	FRIENDSHIPS_SHOW {	
		@Override public String toString() { return "/friendships/show";	 } 
	},
	...
	USERS_SHOW { 
		@Override public String toString() { return "/users/show/:id"; } 
	},
	USERS_SEARCH { 
		@Override public String toString() { return "/users/search"; } 
		@Override public boolean hasApplicationOnlySupport() { return false;	}
	},
	USERS_CONTRIBUTEES { 
		@Override public String toString() { return "/users/contributees"; } 
		@Override public boolean hasApplicationOnlySupport() { return false;	}
	},
	USERS_CONTRIBUTORS { 
		@Override public String toString() { return "/users/contributors"; } 
		@Override public boolean hasApplicationOnlySupport() { return false;	}
	},
	...
	LISTS_MEMBERS_SHOW { 
		@Override public String toString() { return "/lists/members/show"; } 
	},
	LISTS_MEMBERSHIPS {	
		@Override public String toString() { return "/lists/memberships"; }
	},
	LISTS_OWNERSHIPS {	
	...
	GEO_REVERSE_GEOCODE { 
		@Override public String toString() { return "/geo/reverse_geocode"; } 
		@Override public boolean hasApplicationOnlySupport() { return false; }
	},
	GEO_SEARCH { 
		@Override public String toString() { return "/geo/search"; }
		@Override public boolean hasApplicationOnlySupport() { return false;	}
	},
	GEO_SIMILAR_PLACES { 
		@Override public String toString() { return "/geo/similar_places"; } 
		@Override public boolean hasApplicationOnlySupport() { return false;	}
	},
