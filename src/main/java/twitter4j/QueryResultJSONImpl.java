...
final class QueryResultJSONImpl extends TwitterResponseImpl implements QueryResult, java.io.Serializable {
  ...
  /*package*/QueryResultJSONImpl(String src) throws TwitterException {
    try {
      ...
      throw new TwitterException(jsone.getMessage() + ":" + src.toString(), jsone);
    }
  }
  ...
  public String toString() {
    return "QueryResultJSONImpl{" + "sinceId=" + sinceId + ", maxId=" + maxId + ", refreshUrl='" + refreshUrl + '\'' + ", count=" + count + ", completedIn="
        + completedIn + ", query='" + query + '\'' + ", tweets=" + tweets + '}';
  }
}
